...
public class OrderInfoService {
    ...
    /*按照查询条件分页查询订单记录*/
    public ArrayList<OrderInfo> queryOrderInfo(String owner,UserInfo userObj,String liveDate,String orderState,String orderTime,int currentPage) throws Exception { 
     	String where = "where 1=1";
     	where += " and t_minsu.ownerObj='" + owner + "'";
    	if(null != userObj &&  userObj.getUser_name() != null  && !userObj.getUser_name().equals(""))  where += " and t_orderInfo.userObj='" + userObj.getUser_name() + "'";
    	if(!liveDate.equals("")) where = where + " and t_orderInfo.liveDate like '%" + liveDate + "%'";
    	if(!orderState.equals("")) where = where + " and t_orderInfo.orderState like '%" + orderState + "%'";
    	if(!orderTime.equals("")) where = where + " and t_orderInfo.orderTime like '%" + orderTime + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String owner,UserInfo userObj,String liveDate,String orderState,String orderTime) throws Exception {
     	String where = "where 1=1";
     	where += " and t_minsu.ownerObj='" + owner + "'";
    	if(null != userObj &&  userObj.getUser_name() != null && !userObj.getUser_name().equals(""))  where += " and t_orderInfo.userObj='" + userObj.getUser_name() + "'";
    	if(!liveDate.equals("")) where = where + " and t_orderInfo.liveDate like '%" + liveDate + "%'";
