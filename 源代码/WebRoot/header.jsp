...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">民宿管理网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Owner/frontlist">民宿主人</a></li>
                 <li><a href="<%=basePath %>Area/frontlist">地区</a></li>
                <li><a href="<%=basePath %>OrderInfo/frontlist">订单</a></li>
                <li><a href="<%=basePath %>Comment/frontlist">评论</a></li>
                 -->
                <li><a href="<%=basePath %>Minsu/frontlist?areaObj.areaId=1">成都民宿</a></li>
                <li><a href="<%=basePath %>Minsu/frontlist?areaObj.areaId=2">杭州民宿</a></li>
                <li><a href="<%=basePath %>Minsu/frontlist?areaObj.areaId=3">北京民宿</a></li>
                <li><a href="<%=basePath %>Minsu/frontlist?areaObj.areaId=4">上海民宿</a></li>
                <li><a href="<%=basePath %>Minsu/frontlist?areaObj.areaId=5">广州民宿</a></li> 
             ...
             <ul class="nav navbar-nav navbar-right">
             	<%
	  			...
	  			<li><a href="<%=basePath %>Owner/owner_frontAdd.jsp"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;民宿主注册</a></li>
